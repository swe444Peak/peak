...
import 'package:peak/viewmodels/logout_model.dart';
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            ...
            Container(
              padding: EdgeInsets.fromLTRB(width*0.06, height*0.12, width*0.06, 0.0),
              child: Column(
                children: [
                  Row(
                    children: [
                      Padding(
                        padding: EdgeInsets.fromLTRB(0.0,0.0,0.0,(width*0.06)),
                        child: Text("Settings",
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 34.0,
