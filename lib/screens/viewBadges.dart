      ...
      builder: (context, model, child) => Container(
        ...
        child: model.state == ViewState.Busy
            ...
            : GridView.count(
                ...
                children: List.generate(model.badges.length, (index) {
                  return Card(
                    color: Colors.white,
                    elevation: 20,
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Image.asset(
                            "${getBadge(model.badges[index].name, model.badges[index].status)}",
                            width: width * 0.22,
                          ),
                          Text(
                            model.badges[index].name,
                          ...
                          Text(
                            model.badges[index].description,
                            textAlign: TextAlign.center,
                            style: TextStyle(
